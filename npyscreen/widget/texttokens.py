...
class TextTokens(wgtextbox.Textfield, wgwidget.Widget):
    ...
    def __init__(self, *args, **kwargs):
        super(TextTokens, self).__init__(*args, **kwargs)
    ...
    def find_cursor_offset_on_screen(self, position):
        ...
        while index < position:
            ...
            index += 1
        #I don't quite understand why the `- self.begin_at`
    ...
    def print_cursor(self):
        ...
        self.add_line(self.rely,
                      ...
                      #I don't understand why the `- self.begin_at` is needed in
                      #the following line, but it is, or the cursor can end up
                      #overrunning the end of the widget.
    ...
    def h_addch(self, inp):
        if self.editable:
            ...
            if self._last_get_ch_was_unicode is True and isinstance(self.value, bytes):
