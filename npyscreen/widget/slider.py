...
class Slider(widget.Widget):
    def __init__(self, screen, value=0,
        ...
        self.step = step
        self.lowest = lowest
        super(Slider, self).__init__(screen, **kwargs)
    ...
    def translate_value(self):
        """
        What do different values mean?  If you subclass this object, and
        override this method, you can change how the labels are displayed. This
        method should return a unicode string, to be displayed to the user. You
        probably want to ensure this is a fixed width.
        """
    ...
    def update(self, clear=True):
        ...
        for n in range(blocks_on_screen):
            xoffset = self.relx
            if self.do_colors():
                self.parent.curses_pad.addch(self.rely,
                                             n + xoffset,
                                             BACKGROUND_CHAR,
