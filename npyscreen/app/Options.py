...
class OptionListDisplay(widget.MultiLineAction):
...
class OptionChanger(form.ActionPopupWide):
    def on_ok(self,):
...
class Option(object):
    ...
    def __init__(self, name, value=None, documentation=None,
                 short_explanation=None, option_widget_keywords=None,
                 default=None):
        self.name = name
    ...
    def change_option(self):
        ...
        if self.documentation:
            explanation_widget = option_changing_form.add(widget.Pager,
...
class OptionLimitedChoices(Option):
    def __init__(self, name, choices=None, *args, **kwargs):
        super(OptionLimitedChoices, self).__init__(name, *args, **kwargs)
        choices = choices or []
...
class OptionFreeText(Option):
    WIDGET_TO_USE = widget.TitleText


class OptionSingleChoice(OptionLimitedChoices):
    WIDGET_TO_USE = widget.TitleSelectOne


class OptionMultiChoice(OptionLimitedChoices):
    DEFAULT = []
    WIDGET_TO_USE = widget.TitleMultiSelect


class OptionMultiFreeText(Option):
    WIDGET_TO_USE = widget.MultiLineEdit
...
class OptionBoolean(Option):
    WIDGET_TO_USE = widget.Checkbox


class OptionFilename(Option):
    DEFAULT = ''
    WIDGET_TO_USE = widget.FilenameCombo


class OptionDate(Option):
    DEFAULT = None
    WIDGET_TO_USE = widget.DateCombo